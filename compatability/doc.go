...
//
// Compatability also exports a number of structures that help organise the content
...
// in describing the Amiibo's interoperability with other Nintendo products,
// expressing the relational attributes between Nintendo product X and
// the current Amiibo.
//
